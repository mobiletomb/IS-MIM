# Intra-Modality Mask Image Modeling for Brain Tumor Segmentation in Multi-parametric MRI
...
2. We run our code on Python 3.9, PyTorch 1.12.1, CUDA 11.6.0, and cudann 8.4.1.50. Besides software packages required in nnUNet project, **monai** and **SimpleITK** is need install:
```
pip install monai
