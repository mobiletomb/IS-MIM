...
from nnunet.network_architecture.rotation import rotation
...
class RotTrainer(NetworkTrainer):
    def __init__(self, plans_file, fold, output_folder=None,
        ...
        """
        super(RotTrainer, self).__init__(deterministic, fp16)
    ...
    def initialize(self, training=True, force_load_plans=False):
        ...
        self.print_to_log_file('mask type:      | ', 'Rotation')
    ...
    def save_checkpoint(self, fname, save_optimizer=True):
        super(RotTrainer, self).save_checkpoint(fname, save_optimizer)
        info = OrderedDict()
