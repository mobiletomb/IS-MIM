...
from nnunet.network_architecture.jigsaw import gene_pairs
...
class JigTrainer(NetworkTrainer):
    def __init__(self, plans_file, fold, output_folder=None,
        ...
        """
        super(JigTrainer, self).__init__(deterministic, fp16)
    ...
    def initialize(self, training=True, force_load_plans=False):
        ...
        self.print_to_log_file('mask type:      | ', 'Jigsaw')
    ...
    def initialize_network(self):
        ...
        self.head = nn.Sequential(
            ...
            nn.Conv3d(in_channels=1, out_channels=1, kernel_size=16, stride=16),
            nn.Flatten(1),
            nn.Linear(512, 256),
            nn.Linear(256, 100),
            nn.Softmax(dim=1)
        ...
        if self.patience is not None:
            ...
            if self.val_eval_criterion_MA > self.best_val_eval_criterion_MA:
                ...
                if self.save_best_checkpoint:
                    ...
                    torch.save(self.head.state_dict(), join(self.output_folder, "head.pth"))
    ...
    def save_checkpoint(self, fname, save_optimizer=True):
        super(JigTrainer, self).save_checkpoint(fname, save_optimizer)
        info = OrderedDict()
    ...
    def run_iteration(self, data_generator, do_backprop=True, run_online_evaluation=False):
        ...
        data, target, idx = gene_pairs(data)
